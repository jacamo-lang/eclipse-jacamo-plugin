...
@Singleton
public class JcmGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class JcmModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.JcmModel");
		...
		private final Assignment cInstitutionAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cInstitutionInstitutionParserRuleCall_9_0 = (RuleCall)cInstitutionAssignment_9.eContents().get(0);
		private final Assignment cOrganisationAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cOrganisationOrganisationParserRuleCall_10_0 = (RuleCall)cOrganisationAssignment_10.eContents().get(0);
		private final Alternatives cAlternatives_11 = (Alternatives)cGroup.eContents().get(11);
		private final Assignment cDclassPathAssignment_11_0 = (Assignment)cAlternatives_11.eContents().get(0);
		private final RuleCall cDclassPathDClassPathParserRuleCall_11_0_0 = (RuleCall)cDclassPathAssignment_11_0.eContents().get(0);
		private final Assignment cDAslPathAssignment_11_1 = (Assignment)cAlternatives_11.eContents().get(1);
		private final RuleCall cDAslPathDAslPathParserRuleCall_11_1_0 = (RuleCall)cDAslPathAssignment_11_1.eContents().get(0);
		private final Assignment cDOrgPathAssignment_11_2 = (Assignment)cAlternatives_11.eContents().get(2);
		private final RuleCall cDOrgPathDOrgPathParserRuleCall_11_2_0 = (RuleCall)cDOrgPathAssignment_11_2.eContents().get(0);
		private final Assignment cDJavaPathAssignment_11_3 = (Assignment)cAlternatives_11.eContents().get(3);
		private final RuleCall cDJavaPathDJavaPathParserRuleCall_11_3_0 = (RuleCall)cDJavaPathAssignment_11_3.eContents().get(0);
		private final Assignment cDPlatformAssignment_11_4 = (Assignment)cAlternatives_11.eContents().get(4);
		private final RuleCall cDPlatformDPlatformParserRuleCall_11_4_0 = (RuleCall)cDPlatformAssignment_11_4.eContents().get(0);
		private final Assignment cDNodeAssignment_11_5 = (Assignment)cAlternatives_11.eContents().get(5);
		private final RuleCall cDNodeDNodeParserRuleCall_11_5_0 = (RuleCall)cDNodeAssignment_11_5.eContents().get(0);
		...
		//	organisation+=Organisation* (dclassPath+=DClassPath | dAslPath+=DAslPath | dOrgPath+=DOrgPath | dJavaPath+=DJavaPath |
		//	dPlatform+=DPlatform | dNode+=DNode)*
		//	'}' EOL*;
		@Override public ParserRule getRule() { return rule; }
		
		//EOL* 'mas' name=ATOM uses=DUses? EOL* '{' EOL* agent+=Agent* workspace+=Workspace* institution+=Institution*
		//organisation+=Organisation* (dclassPath+=DClassPath | dAslPath+=DAslPath | dOrgPath+=DOrgPath | dJavaPath+=DJavaPath |
		//dPlatform+=DPlatform | dNode+=DNode)* '}' EOL*
		...
		//institution+=Institution*
		public Assignment getInstitutionAssignment_9() { return cInstitutionAssignment_9; }
		
		//Institution
		public RuleCall getInstitutionInstitutionParserRuleCall_9_0() { return cInstitutionInstitutionParserRuleCall_9_0; }
		
		//organisation+=Organisation*
		public Assignment getOrganisationAssignment_10() { return cOrganisationAssignment_10; }
		
		//Organisation
		public RuleCall getOrganisationOrganisationParserRuleCall_10_0() { return cOrganisationOrganisationParserRuleCall_10_0; }
		
		//(dclassPath+=DClassPath | dAslPath+=DAslPath | dOrgPath+=DOrgPath | dJavaPath+=DJavaPath | dPlatform+=DPlatform |
		//dNode+=DNode)*
		public Alternatives getAlternatives_11() { return cAlternatives_11; }
		
		//dclassPath+=DClassPath
		public Assignment getDclassPathAssignment_11_0() { return cDclassPathAssignment_11_0; }
		
		//DClassPath
		public RuleCall getDclassPathDClassPathParserRuleCall_11_0_0() { return cDclassPathDClassPathParserRuleCall_11_0_0; }
		
		//dAslPath+=DAslPath
		public Assignment getDAslPathAssignment_11_1() { return cDAslPathAssignment_11_1; }
		
		//DAslPath
		public RuleCall getDAslPathDAslPathParserRuleCall_11_1_0() { return cDAslPathDAslPathParserRuleCall_11_1_0; }
		
		//dOrgPath+=DOrgPath
		public Assignment getDOrgPathAssignment_11_2() { return cDOrgPathAssignment_11_2; }
		
		//DOrgPath
		public RuleCall getDOrgPathDOrgPathParserRuleCall_11_2_0() { return cDOrgPathDOrgPathParserRuleCall_11_2_0; }
		
		//dJavaPath+=DJavaPath
		public Assignment getDJavaPathAssignment_11_3() { return cDJavaPathAssignment_11_3; }
		
		//DJavaPath
		public RuleCall getDJavaPathDJavaPathParserRuleCall_11_3_0() { return cDJavaPathDJavaPathParserRuleCall_11_3_0; }
		
		//dPlatform+=DPlatform
		public Assignment getDPlatformAssignment_11_4() { return cDPlatformAssignment_11_4; }
		
		//DPlatform
		public RuleCall getDPlatformDPlatformParserRuleCall_11_4_0() { return cDPlatformDPlatformParserRuleCall_11_4_0; }
		
		//dNode+=DNode
		public Assignment getDNodeAssignment_11_5() { return cDNodeAssignment_11_5; }
		
		//DNode
		public RuleCall getDNodeDNodeParserRuleCall_11_5_0() { return cDNodeDNodeParserRuleCall_11_5_0; }
	...
	public class DUsesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DUses");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DClassPathElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DClassPath");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DAslPathElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DAslPath");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DOrgPathElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DOrgPath");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cDOrgPathAction_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cOrgPathKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cColonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Assignment cOrgPathAssignment_3_0 = (Assignment)cGroup_3.eContents().get(0);
		private final RuleCall cOrgPathFileNameParserRuleCall_3_0_0 = (RuleCall)cOrgPathAssignment_3_0.eContents().get(0);
		private final Alternatives cAlternatives_3_1 = (Alternatives)cGroup_3.eContents().get(1);
		private final RuleCall cEOLParserRuleCall_3_1_0 = (RuleCall)cAlternatives_3_1.eContents().get(0);
		private final Keyword cCommaKeyword_3_1_1 = (Keyword)cAlternatives_3_1.eContents().get(1);
		
		//DOrgPath:
		//	{DOrgPath} 'org-path' ':' (orgPath+=FileName (EOL | ',')+)*;
		@Override public ParserRule getRule() { return rule; }
		...
		//{DOrgPath}
		public Action getDOrgPathAction_0() { return cDOrgPathAction_0; }
		
		//'org-path'
		public Keyword getOrgPathKeyword_1() { return cOrgPathKeyword_1; }
		
		//':'
		public Keyword getColonKeyword_2() { return cColonKeyword_2; }
		
		//(orgPath+=FileName (EOL | ',')+)*
		public Group getGroup_3() { return cGroup_3; }
		
		//orgPath+=FileName
		public Assignment getOrgPathAssignment_3_0() { return cOrgPathAssignment_3_0; }
		
		//FileName
		public RuleCall getOrgPathFileNameParserRuleCall_3_0_0() { return cOrgPathFileNameParserRuleCall_3_0_0; }
	...
	public class DJavaPathElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DJavaPath");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cDJavaPathAction_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cJavaPathKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cColonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Assignment cAslPathAssignment_3_0 = (Assignment)cGroup_3.eContents().get(0);
		private final RuleCall cAslPathFileNameParserRuleCall_3_0_0 = (RuleCall)cAslPathAssignment_3_0.eContents().get(0);
		...
		//DJavaPath:
		//	{DJavaPath} 'java-path' ':' (aslPath+=FileName (EOL | ',')+)*;
		@Override public ParserRule getRule() { return rule; }
		...
		//{DJavaPath}
		public Action getDJavaPathAction_0() { return cDJavaPathAction_0; }
		
		//'java-path'
		public Keyword getJavaPathKeyword_1() { return cJavaPathKeyword_1; }
	...
	public class DPlatformElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DPlatform");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AgentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Agent");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Keyword cColonColonKeyword_3_2_7_2_1_0 = (Keyword)cGroup_3_2_7_2_1.eContents().get(0);
		private final Assignment cFocusNSAssignment_3_2_7_2_1_1 = (Assignment)cGroup_3_2_7_2_1.eContents().get(1);
		private final RuleCall cFocusNSATOMTerminalRuleCall_3_2_7_2_1_1_0 = (RuleCall)cFocusNSAssignment_3_2_7_2_1_1.eContents().get(0);
		private final Group cGroup_3_2_7_2_2 = (Group)cGroup_3_2_7_2.eContents().get(2);
		private final Keyword cCommercialAtKeyword_3_2_7_2_2_0 = (Keyword)cGroup_3_2_7_2_2.eContents().get(0);
		private final Assignment cFocusNodeAssignment_3_2_7_2_2_1 = (Assignment)cGroup_3_2_7_2_2.eContents().get(1);
		private final RuleCall cFocusNodeATOMTerminalRuleCall_3_2_7_2_2_1_0 = (RuleCall)cFocusNodeAssignment_3_2_7_2_2_1.eContents().get(0);
		private final Alternatives cAlternatives_3_2_7_2_3 = (Alternatives)cGroup_3_2_7_2.eContents().get(3);
		private final RuleCall cEOLParserRuleCall_3_2_7_2_3_0 = (RuleCall)cAlternatives_3_2_7_2_3.eContents().get(0);
		private final Keyword cCommaKeyword_3_2_7_2_3_1 = (Keyword)cAlternatives_3_2_7_2_3.eContents().get(1);
		...
		//	'intBels' ':' ('sameFocus' | 'newFocus') EOL+ | other+=ATOM ":" (string+=STRING | val+=INT_LITERAL | literal+=Literal
		...
		//(EOL | ',')+)* | 'goals' ':' (goals+=Literal (EOL | ',')+)* | 'focus' ':' (focus+=ATOM ('::' focusNS+=ATOM)? ('@'
		//focusNode+=ATOM)? (EOL | ',')+)* | 'join' ':' (join+=ATOM ('@' joinNode+=ATOM)? (EOL | ',')+)* | 'roles' ':'
		//(role+=ATOM 'in' group+=ATOM ('@' groupNode+=ATOM)? (EOL | ',')+)* | 'debug' ':' debug+=Literal (EOL | ',')+ |
		//'verbose' ':' verbose+=INT_LITERAL EOL+ | 'nrcbp' ':' nrcbp+=INT_LITERAL EOL+ | 'events' ':' ('discard' | 'requeue' |
		//'retrieve') EOL+ | 'intBels' ':' ('sameFocus' | 'newFocus') EOL+ | other+=ATOM ":" (string+=STRING | val+=INT_LITERAL |
		//literal+=Literal | val_real+=REAL_LITERAL) EOL+)* '}')? EOL*
		public Group getGroup() { return cGroup; }
		...
		//(goals+=Literal (EOL | ',')+)* | 'focus' ':' (focus+=ATOM ('::' focusNS+=ATOM)? ('@' focusNode+=ATOM)? (EOL | ',')+)* |
		...
		//| 'focus' ':' (focus+=ATOM ('::' focusNS+=ATOM)? ('@' focusNode+=ATOM)? (EOL | ',')+)* | 'join' ':' (join+=ATOM ('@'
		//joinNode+=ATOM)? (EOL | ',')+)* | 'roles' ':' (role+=ATOM 'in' group+=ATOM ('@' groupNode+=ATOM)? (EOL | ',')+)* |
		//'debug' ':' debug+=Literal (EOL | ',')+ | 'verbose' ':' verbose+=INT_LITERAL EOL+ | 'nrcbp' ':' nrcbp+=INT_LITERAL EOL+
		//| 'events' ':' ('discard' | 'requeue' | 'retrieve') EOL+ | 'intBels' ':' ('sameFocus' | 'newFocus') EOL+ | other+=ATOM
		//":" (string+=STRING | val+=INT_LITERAL | literal+=Literal | val_real+=REAL_LITERAL) EOL+)*
		...
		//(focus+=ATOM ('::' focusNS+=ATOM)? ('@' focusNode+=ATOM)? (EOL | ',')+)*
		...
		//'::'
		public Keyword getColonColonKeyword_3_2_7_2_1_0() { return cColonColonKeyword_3_2_7_2_1_0; }
		
		//focusNS+=ATOM
		public Assignment getFocusNSAssignment_3_2_7_2_1_1() { return cFocusNSAssignment_3_2_7_2_1_1; }
		
		//ATOM
		public RuleCall getFocusNSATOMTerminalRuleCall_3_2_7_2_1_1_0() { return cFocusNSATOMTerminalRuleCall_3_2_7_2_1_1_0; }
		
		//('@' focusNode+=ATOM)?
		public Group getGroup_3_2_7_2_2() { return cGroup_3_2_7_2_2; }
		
		//'@'
		public Keyword getCommercialAtKeyword_3_2_7_2_2_0() { return cCommercialAtKeyword_3_2_7_2_2_0; }
		
		//focusNode+=ATOM
		public Assignment getFocusNodeAssignment_3_2_7_2_2_1() { return cFocusNodeAssignment_3_2_7_2_2_1; }
		
		//ATOM
		public RuleCall getFocusNodeATOMTerminalRuleCall_3_2_7_2_2_1_0() { return cFocusNodeATOMTerminalRuleCall_3_2_7_2_2_1_0; }
		
		//(EOL | ',')+
		public Alternatives getAlternatives_3_2_7_2_3() { return cAlternatives_3_2_7_2_3; }
		
		//EOL
		public RuleCall getEOLParserRuleCall_3_2_7_2_3_0() { return cEOLParserRuleCall_3_2_7_2_3_0; }
		
		//','
		public Keyword getCommaKeyword_3_2_7_2_3_1() { return cCommaKeyword_3_2_7_2_3_1; }
	...
	public class WorkspaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Workspace");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Workspace:
		//	'workspace' name=ATOM '{' EOL* (artifact+=Artifact |
		//	'agents' ':' ((agent+=ATOM | '*') (EOL | ',')+)* |
		//	'debug' (':' debug+=Literal)? EOL+ | node+=ONode)* '}' EOL*;
		@Override public ParserRule getRule() { return rule; }
	...
	public class ArtifactElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Artifact");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Group cGroup_4_2_2_0 = (Group)cGroup_4_2_2.eContents().get(0);
		private final Assignment cAgentNSAssignment_4_2_2_0_0 = (Assignment)cGroup_4_2_2_0.eContents().get(0);
		private final RuleCall cAgentNSATOMTerminalRuleCall_4_2_2_0_0_0 = (RuleCall)cAgentNSAssignment_4_2_2_0_0.eContents().get(0);
		private final Keyword cColonColonKeyword_4_2_2_0_1 = (Keyword)cGroup_4_2_2_0.eContents().get(1);
		private final Alternatives cAlternatives_4_2_2_1 = (Alternatives)cGroup_4_2_2.eContents().get(1);
		private final Assignment cAgentAssignment_4_2_2_1_0 = (Assignment)cAlternatives_4_2_2_1.eContents().get(0);
		private final RuleCall cAgentATOMTerminalRuleCall_4_2_2_1_0_0 = (RuleCall)cAgentAssignment_4_2_2_1_0.eContents().get(0);
		private final Keyword cAsteriskKeyword_4_2_2_1_1 = (Keyword)cAlternatives_4_2_2_1.eContents().get(1);
		private final Alternatives cAlternatives_4_2_2_2 = (Alternatives)cGroup_4_2_2.eContents().get(2);
		private final RuleCall cEOLParserRuleCall_4_2_2_2_0 = (RuleCall)cAlternatives_4_2_2_2.eContents().get(0);
		private final Keyword cCommaKeyword_4_2_2_2_1 = (Keyword)cAlternatives_4_2_2_2.eContents().get(1);
		private final Keyword cRightCurlyBracketKeyword_4_3 = (Keyword)cGroup_4.eContents().get(3);
		private final RuleCall cEOLParserRuleCall_5 = (RuleCall)cGroup.eContents().get(5);
		
		//Artifact:
		//	'artifact' name=ATOM ':' classDef=ClassDef ('{' EOL* ('focused-by' ":" ((agentNS+=ATOM '::')? (agent+=ATOM | '*') (EOL
		//	| ',')+)*)? '}')? EOL*;
		@Override public ParserRule getRule() { return rule; }
		...
		//('{' EOL* ('focused-by' ":" ((agentNS+=ATOM '::')? (agent+=ATOM | '*') (EOL | ',')+)*)? '}')?
		...
		//agentNS+=ATOM
		public Assignment getAgentNSAssignment_4_2_2_0_0() { return cAgentNSAssignment_4_2_2_0_0; }
		
		//ATOM
		public RuleCall getAgentNSATOMTerminalRuleCall_4_2_2_0_0_0() { return cAgentNSATOMTerminalRuleCall_4_2_2_0_0_0; }
		
		//'::'
		public Keyword getColonColonKeyword_4_2_2_0_1() { return cColonColonKeyword_4_2_2_0_1; }
		
		//(agent+=ATOM | '*')
		public Alternatives getAlternatives_4_2_2_1() { return cAlternatives_4_2_2_1; }
		
		//agent+=ATOM
		public Assignment getAgentAssignment_4_2_2_1_0() { return cAgentAssignment_4_2_2_1_0; }
		
		//ATOM
		public RuleCall getAgentATOMTerminalRuleCall_4_2_2_1_0_0() { return cAgentATOMTerminalRuleCall_4_2_2_1_0_0; }
		
		//'*'
		public Keyword getAsteriskKeyword_4_2_2_1_1() { return cAsteriskKeyword_4_2_2_1_1; }
		
		//(EOL | ',')+
		public Alternatives getAlternatives_4_2_2_2() { return cAlternatives_4_2_2_2; }
		
		//EOL
		public RuleCall getEOLParserRuleCall_4_2_2_2_0() { return cEOLParserRuleCall_4_2_2_2_0; }
		
		//','
		public Keyword getCommaKeyword_4_2_2_2_1() { return cCommaKeyword_4_2_2_2_1; }
	...
	public class InstitutionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Institution");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cInstitutionKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameATOMTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		...
		private final Keyword cWorkspacesKeyword_5_0_0 = (Keyword)cGroup_5_0.eContents().get(0);
		...
		private final Assignment cWsNamesAssignment_5_0_2_0 = (Assignment)cGroup_5_0_2.eContents().get(0);
		private final RuleCall cWsNamesATOMTerminalRuleCall_5_0_2_0_0 = (RuleCall)cWsNamesAssignment_5_0_2_0.eContents().get(0);
		private final Alternatives cAlternatives_5_0_2_1 = (Alternatives)cGroup_5_0_2.eContents().get(1);
		private final RuleCall cEOLParserRuleCall_5_0_2_1_0 = (RuleCall)cAlternatives_5_0_2_1.eContents().get(0);
		private final Keyword cCommaKeyword_5_0_2_1_1 = (Keyword)cAlternatives_5_0_2_1.eContents().get(1);
		private final Group cGroup_5_1 = (Group)cAlternatives_5.eContents().get(1);
		private final Keyword cDebugKeyword_5_1_0 = (Keyword)cGroup_5_1.eContents().get(0);
		private final RuleCall cEOLParserRuleCall_5_1_1 = (RuleCall)cGroup_5_1.eContents().get(1);
		private final Group cGroup_5_2 = (Group)cAlternatives_5.eContents().get(2);
		private final Assignment cOtherAssignment_5_2_0 = (Assignment)cGroup_5_2.eContents().get(0);
		private final RuleCall cOtherATOMTerminalRuleCall_5_2_0_0 = (RuleCall)cOtherAssignment_5_2_0.eContents().get(0);
		...
		private final Assignment cStringAssignment_5_2_2_0 = (Assignment)cAlternatives_5_2_2.eContents().get(0);
		private final RuleCall cStringSTRINGTerminalRuleCall_5_2_2_0_0 = (RuleCall)cStringAssignment_5_2_2_0.eContents().get(0);
		private final Assignment cValAssignment_5_2_2_1 = (Assignment)cAlternatives_5_2_2.eContents().get(1);
		private final RuleCall cValINT_LITERALTerminalRuleCall_5_2_2_1_0 = (RuleCall)cValAssignment_5_2_2_1.eContents().get(0);
		private final Assignment cLiteralAssignment_5_2_2_2 = (Assignment)cAlternatives_5_2_2.eContents().get(2);
		private final RuleCall cLiteralLiteralParserRuleCall_5_2_2_2_0 = (RuleCall)cLiteralAssignment_5_2_2_2.eContents().get(0);
		private final Assignment cVal_realAssignment_5_2_2_3 = (Assignment)cAlternatives_5_2_2.eContents().get(3);
		private final RuleCall cVal_realREAL_LITERALTerminalRuleCall_5_2_2_3_0 = (RuleCall)cVal_realAssignment_5_2_2_3.eContents().get(0);
		private final RuleCall cEOLParserRuleCall_5_2_3 = (RuleCall)cGroup_5_2.eContents().get(3);
		private final Keyword cRightCurlyBracketKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final RuleCall cEOLParserRuleCall_7 = (RuleCall)cGroup.eContents().get(7);
		
		//Institution:
		//	'institution' name=ATOM fileName=OFileName? '{' EOL* ('workspaces' ':' (wsNames+=ATOM (EOL | ',')+)+ |
		//	'debug' EOL+ | other+=ATOM ':' (string+=STRING | val+=INT_LITERAL | literal+=Literal | val_real+=REAL_LITERAL) EOL+)*
		//	'}' EOL*;
		@Override public ParserRule getRule() { return rule; }
		
		//'institution' name=ATOM fileName=OFileName? '{' EOL* ('workspaces' ':' (wsNames+=ATOM (EOL | ',')+)+ | 'debug' EOL+ |
		//other+=ATOM ':' (string+=STRING | val+=INT_LITERAL | literal+=Literal | val_real+=REAL_LITERAL) EOL+)* '}' EOL*
		public Group getGroup() { return cGroup; }
		
		//'institution'
		public Keyword getInstitutionKeyword_0() { return cInstitutionKeyword_0; }
		...
		//('workspaces' ':' (wsNames+=ATOM (EOL | ',')+)+ | 'debug' EOL+ | other+=ATOM ':' (string+=STRING | val+=INT_LITERAL |
		...
		//'workspaces'
		public Keyword getWorkspacesKeyword_5_0_0() { return cWorkspacesKeyword_5_0_0; }
		...
		//wsNames+=ATOM
		public Assignment getWsNamesAssignment_5_0_2_0() { return cWsNamesAssignment_5_0_2_0; }
		
		//ATOM
		public RuleCall getWsNamesATOMTerminalRuleCall_5_0_2_0_0() { return cWsNamesATOMTerminalRuleCall_5_0_2_0_0; }
		
		//(EOL | ',')+
		public Alternatives getAlternatives_5_0_2_1() { return cAlternatives_5_0_2_1; }
		
		//EOL
		public RuleCall getEOLParserRuleCall_5_0_2_1_0() { return cEOLParserRuleCall_5_0_2_1_0; }
		
		//','
		public Keyword getCommaKeyword_5_0_2_1_1() { return cCommaKeyword_5_0_2_1_1; }
		
		//'debug' EOL+
		public Group getGroup_5_1() { return cGroup_5_1; }
		
		//'debug'
		public Keyword getDebugKeyword_5_1_0() { return cDebugKeyword_5_1_0; }
		
		//EOL+
		public RuleCall getEOLParserRuleCall_5_1_1() { return cEOLParserRuleCall_5_1_1; }
		
		//other+=ATOM ':' (string+=STRING | val+=INT_LITERAL | literal+=Literal | val_real+=REAL_LITERAL) EOL+
		public Group getGroup_5_2() { return cGroup_5_2; }
		
		//other+=ATOM
		public Assignment getOtherAssignment_5_2_0() { return cOtherAssignment_5_2_0; }
		
		//ATOM
		public RuleCall getOtherATOMTerminalRuleCall_5_2_0_0() { return cOtherATOMTerminalRuleCall_5_2_0_0; }
		...
		//string+=STRING
		public Assignment getStringAssignment_5_2_2_0() { return cStringAssignment_5_2_2_0; }
		
		//STRING
		public RuleCall getStringSTRINGTerminalRuleCall_5_2_2_0_0() { return cStringSTRINGTerminalRuleCall_5_2_2_0_0; }
		
		//val+=INT_LITERAL
		public Assignment getValAssignment_5_2_2_1() { return cValAssignment_5_2_2_1; }
		
		//INT_LITERAL
		public RuleCall getValINT_LITERALTerminalRuleCall_5_2_2_1_0() { return cValINT_LITERALTerminalRuleCall_5_2_2_1_0; }
		
		//literal+=Literal
		public Assignment getLiteralAssignment_5_2_2_2() { return cLiteralAssignment_5_2_2_2; }
		
		//Literal
		public RuleCall getLiteralLiteralParserRuleCall_5_2_2_2_0() { return cLiteralLiteralParserRuleCall_5_2_2_2_0; }
		
		//val_real+=REAL_LITERAL
		public Assignment getVal_realAssignment_5_2_2_3() { return cVal_realAssignment_5_2_2_3; }
		
		//REAL_LITERAL
		public RuleCall getVal_realREAL_LITERALTerminalRuleCall_5_2_2_3_0() { return cVal_realREAL_LITERALTerminalRuleCall_5_2_2_3_0; }
		
		//EOL+
		public RuleCall getEOLParserRuleCall_5_2_3() { return cEOLParserRuleCall_5_2_3; }
	...
	public class OrganisationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Organisation");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cSituatedAssignment_5_4 = (Assignment)cAlternatives_5.eContents().get(4);
		private final RuleCall cSituatedOSituatedParserRuleCall_5_4_0 = (RuleCall)cSituatedAssignment_5_4.eContents().get(0);
		private final Assignment cOtherAssignment_5_5 = (Assignment)cAlternatives_5.eContents().get(5);
		private final RuleCall cOtherOOthersParserRuleCall_5_5_0 = (RuleCall)cOtherAssignment_5_5.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final RuleCall cEOLParserRuleCall_7 = (RuleCall)cGroup.eContents().get(7);
		
		//Organisation:
		//	'organisation' name=ATOM fileName=OFileName? '{' EOL* (group+=Group | scheme+=Scheme | agents+=OAgents | node+=ONode |
		//	situated+=OSituated | other+=OOthers)* '}' EOL*;
		@Override public ParserRule getRule() { return rule; }
		...
		//(group+=Group | scheme+=Scheme | agents+=OAgents | node+=ONode | situated+=OSituated | other+=OOthers)*
		public Alternatives getAlternatives_5() { return cAlternatives_5; }
		...
		//situated+=OSituated
		public Assignment getSituatedAssignment_5_4() { return cSituatedAssignment_5_4; }
		
		//OSituated
		public RuleCall getSituatedOSituatedParserRuleCall_5_4_0() { return cSituatedOSituatedParserRuleCall_5_4_0; }
		
		//other+=OOthers
		public Assignment getOtherAssignment_5_5() { return cOtherAssignment_5_5; }
		
		//OOthers
		public RuleCall getOtherOOthersParserRuleCall_5_5_0() { return cOtherOOthersParserRuleCall_5_5_0; }
	...
	public class OFileNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.OFileName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ONodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.ONode");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cNodeKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class OSituatedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.OSituated");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cSituatedKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cNameAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cNameATOMTerminalRuleCall_2_0 = (RuleCall)cNameAssignment_2.eContents().get(0);
		private final RuleCall cEOLParserRuleCall_3 = (RuleCall)cGroup.eContents().get(3);
		...
		//'situated'
		public Keyword getSituatedKeyword_0() { return cSituatedKeyword_0; }
	...
	public class OAgentsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.OAgents");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OOthersElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.OOthers");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GroupElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Group");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Group cGroup_4_2_1_2 = (Group)cGroup_4_2_1.eContents().get(2);
		private final Assignment cResponsibleForAssignment_4_2_1_2_0 = (Assignment)cGroup_4_2_1_2.eContents().get(0);
		private final RuleCall cResponsibleForATOMTerminalRuleCall_4_2_1_2_0_0 = (RuleCall)cResponsibleForAssignment_4_2_1_2_0.eContents().get(0);
		private final Alternatives cAlternatives_4_2_1_2_1 = (Alternatives)cGroup_4_2_1_2.eContents().get(1);
		private final RuleCall cEOLParserRuleCall_4_2_1_2_1_0 = (RuleCall)cAlternatives_4_2_1_2_1.eContents().get(0);
		private final Keyword cCommaKeyword_4_2_1_2_1_1 = (Keyword)cAlternatives_4_2_1_2_1.eContents().get(1);
		...
		//Group:
		//	'group' name=ATOM ':' kind=ATOM ('{' EOL* (group+=Group |
		//	'responsible-for' ':' (responsibleFor+=ATOM (EOL | ',')+)+ |
		//	'owner' ':' owner+=ATOM EOL+ |
		//	'debug' (':' debug+=Literal)? EOL+ | other+=ATOM ':' (string+=STRING | val+=INT_LITERAL | literal+=Literal |
		//	val_real+=REAL_LITERAL) EOL+ |
		//	'players' ':' (agent+=ATOM role+=ATOM (EOL | ',')+)*)* "}")? EOL*;
		@Override public ParserRule getRule() { return rule; }
		
		//'group' name=ATOM ':' kind=ATOM ('{' EOL* (group+=Group | 'responsible-for' ':' (responsibleFor+=ATOM (EOL | ',')+)+ |
		//'owner' ':' owner+=ATOM EOL+ | 'debug' (':' debug+=Literal)? EOL+ | other+=ATOM ':' (string+=STRING | val+=INT_LITERAL
		...
		//('{' EOL* (group+=Group | 'responsible-for' ':' (responsibleFor+=ATOM (EOL | ',')+)+ | 'owner' ':' owner+=ATOM EOL+ |
		//'debug' (':' debug+=Literal)? EOL+ | other+=ATOM ':' (string+=STRING | val+=INT_LITERAL | literal+=Literal |
		//val_real+=REAL_LITERAL) EOL+ | 'players' ':' (agent+=ATOM role+=ATOM (EOL | ',')+)*)* "}")?
		public Group getGroup_4() { return cGroup_4; }
		...
		//(responsibleFor+=ATOM (EOL | ',')+)+
		public Group getGroup_4_2_1_2() { return cGroup_4_2_1_2; }
		
		//responsibleFor+=ATOM
		public Assignment getResponsibleForAssignment_4_2_1_2_0() { return cResponsibleForAssignment_4_2_1_2_0; }
		
		//ATOM
		public RuleCall getResponsibleForATOMTerminalRuleCall_4_2_1_2_0_0() { return cResponsibleForATOMTerminalRuleCall_4_2_1_2_0_0; }
		
		//(EOL | ',')+
		public Alternatives getAlternatives_4_2_1_2_1() { return cAlternatives_4_2_1_2_1; }
		
		//EOL
		public RuleCall getEOLParserRuleCall_4_2_1_2_1_0() { return cEOLParserRuleCall_4_2_1_2_1_0; }
		
		//','
		public Keyword getCommaKeyword_4_2_1_2_1_1() { return cCommaKeyword_4_2_1_2_1_1; }
	...
	public class SchemeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Scheme");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Scheme:
		//	'scheme' name=ATOM ':' kind=ATOM ('{' EOL* ('debug' (':' debug+=Literal)? EOL+ |
		//	'owner' ':' owner+=ATOM EOL+ | other+=ATOM ":" (string+=STRING | val+=INT_LITERAL | literal+=Literal |
		//	val_real+=REAL_LITERAL) EOL+)* "}")? EOL*;
		@Override public ParserRule getRule() { return rule; }
	...
	public class HostElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Host");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FileNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.FileName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ClassDefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.ClassDef");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Parameter");
	...
	public class ListParametersElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.ListParameters");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Literal");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PredElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Pred");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TermsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Terms");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TermElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Term");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ListElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.List");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VarElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.Var");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
	...
	public class EOLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.EOL");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FQNElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.FQN");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
	...
	private final JcmModelElements pJcmModel;
	private final DUsesElements pDUses;
	private final DClassPathElements pDClassPath;
	private final DAslPathElements pDAslPath;
	private final DOrgPathElements pDOrgPath;
	private final DJavaPathElements pDJavaPath;
	private final DPlatformElements pDPlatform;
	private final DNodeElements pDNode;
	private final AgentElements pAgent;
	private final WorkspaceElements pWorkspace;
	private final ArtifactElements pArtifact;
	private final InstitutionElements pInstitution;
	private final OrganisationElements pOrganisation;
	private final OFileNameElements pOFileName;
	private final ONodeElements pONode;
	private final OSituatedElements pOSituated;
	private final OAgentsElements pOAgents;
	private final OOthersElements pOOthers;
	private final GroupElements pGroup;
	private final SchemeElements pScheme;
	private final HostElements pHost;
	private final FileNameElements pFileName;
	private final ClassDefElements pClassDef;
	private final ParameterElements pParameter;
	private final ListParametersElements pListParameters;
	...
	private final TerminalRule tIP;
	...
	private final TerminalRule tREAL_LITERAL;
	...
	public JcmGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.pJcmModel = new JcmModelElements();
		this.pDUses = new DUsesElements();
		this.pDClassPath = new DClassPathElements();
		this.pDAslPath = new DAslPathElements();
		this.pDOrgPath = new DOrgPathElements();
		this.pDJavaPath = new DJavaPathElements();
		this.pDPlatform = new DPlatformElements();
		this.pDNode = new DNodeElements();
		this.pAgent = new AgentElements();
		this.pWorkspace = new WorkspaceElements();
		this.pArtifact = new ArtifactElements();
		this.pInstitution = new InstitutionElements();
		this.pOrganisation = new OrganisationElements();
		this.pOFileName = new OFileNameElements();
		this.pONode = new ONodeElements();
		this.pOSituated = new OSituatedElements();
		this.pOAgents = new OAgentsElements();
		this.pOOthers = new OOthersElements();
		this.pGroup = new GroupElements();
		this.pScheme = new SchemeElements();
		this.pHost = new HostElements();
		this.pFileName = new FileNameElements();
		this.pClassDef = new ClassDefElements();
		this.pParameter = new ParameterElements();
		this.pListParameters = new ListParametersElements();
		...
		this.tIP = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.IP");
		this.tATOM = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.ATOM");
		this.tVART = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.VART");
		this.tUNNAMEDVART = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.UNNAMEDVART");
		this.tCHAR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.CHAR");
		this.tLETTER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.LETTER");
		this.tLCLETTER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.LCLETTER");
		this.tUCLETTER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.UCLETTER");
		this.tDIGIT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.DIGIT");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.STRING");
		this.tINT_LITERAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.INT_LITERAL");
		this.tREAL_LITERAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.REAL_LITERAL");
		this.tIntegerNumber = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.IntegerNumber");
		this.tHexPrefix = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.HexPrefix");
		this.tHexDigit = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.HexDigit");
		this.tWS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.WS");
		this.tML_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.ML_COMMENT");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.SL_COMMENT");
		this.tNEWLINE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "jacamoide.xtext.jcm.Jcm.NEWLINE");
	}
	...
	//DOrgPath:
	//	{DOrgPath} 'org-path' ':' (orgPath+=FileName (EOL | ',')+)*;
	public DOrgPathElements getDOrgPathAccess() {
		return pDOrgPath;
	}
	
	public ParserRule getDOrgPathRule() {
		return getDOrgPathAccess().getRule();
	}
	
	//DJavaPath:
	//	{DJavaPath} 'java-path' ':' (aslPath+=FileName (EOL | ',')+)*;
	public DJavaPathElements getDJavaPathAccess() {
		return pDJavaPath;
	}
	
	public ParserRule getDJavaPathRule() {
		return getDJavaPathAccess().getRule();
	}
	...
	//	'debug' EOL+ | other+=ATOM ':' (string+=STRING | val+=INT_LITERAL | literal+=Literal | val_real+=REAL_LITERAL) EOL+)*
	//	'}' EOL*;
	public InstitutionElements getInstitutionAccess() {
		return pInstitution;
	}
	
	public ParserRule getInstitutionRule() {
		return getInstitutionAccess().getRule();
	}
	...
	//OSituated:
	//	'situated' ':' name=ATOM EOL+;
	public OSituatedElements getOSituatedAccess() {
		return pOSituated;
	}
	
	public ParserRule getOSituatedRule() {
		return getOSituatedAccess().getRule();
	}

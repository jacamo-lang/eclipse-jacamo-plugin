 ...
 *   <li>{@link jacamoide.xtext.jcm.jcm.impl.AgentImpl#getFocusNS <em>Focus NS</em>}</li>
...
public class AgentImpl extends MinimalEObjectImpl.Container implements Agent
{
  ...
  /**
   * The cached value of the '{@link #getFocusNS() <em>Focus NS</em>}' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getFocusNS()
   * @generated
   * @ordered
   */
  protected EList<String> focusNS;
   ...
   */
  @Override
  public EList<String> getFocusNS()
  {
    if (focusNS == null)
    {
      focusNS = new EDataTypeEList<String>(String.class, this, JcmPackage.AGENT__FOCUS_NS);
    }
    return focusNS;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case JcmPackage.AGENT__FOCUS:
        return getFocus();
      case JcmPackage.AGENT__FOCUS_NS:
        return getFocusNS();
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case JcmPackage.AGENT__FOCUS_NS:
        getFocusNS().clear();
        getFocusNS().addAll((Collection<? extends String>)newValue);
        return;
      case JcmPackage.AGENT__FOCUS_NODE:
        getFocusNode().clear();
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case JcmPackage.AGENT__FOCUS_NS:
        return focusNS != null && !focusNS.isEmpty();
      case JcmPackage.AGENT__FOCUS_NODE:

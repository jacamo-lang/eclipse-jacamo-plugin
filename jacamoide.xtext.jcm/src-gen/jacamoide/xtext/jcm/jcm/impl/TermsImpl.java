 ...
 * <ul>
 *   <li>{@link jacamoide.xtext.jcm.jcm.impl.TermsImpl#getTerm <em>Term</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TermsImpl extends MinimalEObjectImpl.Container implements Terms
{
  ...
  {
    return JcmPackage.Literals.TERMS;
  }
  ...
  public EList<Term> getTerm()
  {
    if (term == null)
    {
      term = new EObjectContainmentEList<Term>(Term.class, this, JcmPackage.TERMS__TERM);
    }
    return term;
  }

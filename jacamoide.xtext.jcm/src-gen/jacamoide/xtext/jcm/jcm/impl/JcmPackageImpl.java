...
public class JcmPackageImpl extends EPackageImpl implements JcmPackage
{
   ...
   * @generated
   */
  private EClass dOrgPathEClass = null;
   ...
   * @generated
   */
  private EClass dJavaPathEClass = null;
   ...
   * @generated
   */
  private EClass oSituatedEClass = null;
  ...
  public static JcmPackage init()
  {
    ...
    Object registeredJcmPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    JcmPackageImpl theJcmPackage = registeredJcmPackage instanceof JcmPackageImpl ? (JcmPackageImpl)registeredJcmPackage : new JcmPackageImpl();
   ...
   */
  @Override
  public EReference getJcmModel_Institution()
  {
   ...
   */
  @Override
  public EReference getJcmModel_DOrgPath()
  {
   ...
   */
  @Override
  public EReference getJcmModel_DJavaPath()
  {
    return (EReference)jcmModelEClass.getEStructuralFeatures().get(9);
  }
  ...
  {
    return (EReference)jcmModelEClass.getEStructuralFeatures().get(10);
  }
  ...
  {
    return (EReference)jcmModelEClass.getEStructuralFeatures().get(11);
  }
   ...
   */
  @Override
  public EClass getDOrgPath()
  {
    return dOrgPathEClass;
  }
   ...
   */
  @Override
  public EReference getDOrgPath_OrgPath()
  {
    return (EReference)dOrgPathEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getDJavaPath()
  {
    return dJavaPathEClass;
  }
   ...
   */
  @Override
  public EReference getDJavaPath_AslPath()
  {
    return (EReference)dJavaPathEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getAgent_FocusNS()
  {
  ...
  {
    return (EAttribute)agentEClass.getEStructuralFeatures().get(17);
  }
  ...
  {
    return (EReference)agentEClass.getEStructuralFeatures().get(18);
  }
  ...
  {
    return (EAttribute)agentEClass.getEStructuralFeatures().get(23);
  }
  ...
  {
    return (EReference)agentEClass.getEStructuralFeatures().get(24);
  }
  ...
  {
    return (EAttribute)agentEClass.getEStructuralFeatures().get(25);
  }
   ...
   */
  @Override
  public EAttribute getArtifact_AgentNS()
  {
   ...
   */
  @Override
  public EReference getInstitution_FileName()
  {
   ...
   */
  @Override
  public EAttribute getInstitution_WsNames()
  {
   ...
   */
  @Override
  public EAttribute getInstitution_Other()
  {
   ...
   */
  @Override
  public EAttribute getInstitution_String()
  {
   ...
   */
  @Override
  public EAttribute getInstitution_Val()
  {
    return (EAttribute)institutionEClass.getEStructuralFeatures().get(5);
  }
   ...
   */
  @Override
  public EReference getInstitution_Literal()
  {
    return (EReference)institutionEClass.getEStructuralFeatures().get(6);
  }
   ...
   */
  @Override
  public EAttribute getInstitution_Val_real()
  {
    return (EAttribute)institutionEClass.getEStructuralFeatures().get(7);
  }
   ...
   */
  @Override
  public EReference getOrganisation_Situated()
  {
   ...
   */
  @Override
  public EClass getOSituated()
  {
    return oSituatedEClass;
  }
   ...
   */
  @Override
  public EAttribute getOSituated_Name()
  {
    return (EAttribute)oSituatedEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(jcmModelEClass, JCM_MODEL__INSTITUTION);
    ...
    createEReference(jcmModelEClass, JCM_MODEL__DORG_PATH);
    createEReference(jcmModelEClass, JCM_MODEL__DJAVA_PATH);
    ...
    dOrgPathEClass = createEClass(DORG_PATH);
    createEReference(dOrgPathEClass, DORG_PATH__ORG_PATH);

    dJavaPathEClass = createEClass(DJAVA_PATH);
    createEReference(dJavaPathEClass, DJAVA_PATH__ASL_PATH);
    ...
    createEAttribute(agentEClass, AGENT__FOCUS_NS);
    ...
    createEAttribute(artifactEClass, ARTIFACT__AGENT_NS);
    ...
    createEReference(institutionEClass, INSTITUTION__FILE_NAME);
    createEAttribute(institutionEClass, INSTITUTION__WS_NAMES);
    createEAttribute(institutionEClass, INSTITUTION__OTHER);
    createEAttribute(institutionEClass, INSTITUTION__STRING);
    createEAttribute(institutionEClass, INSTITUTION__VAL);
    createEReference(institutionEClass, INSTITUTION__LITERAL);
    createEAttribute(institutionEClass, INSTITUTION__VAL_REAL);
    ...
    createEReference(organisationEClass, ORGANISATION__SITUATED);
    ...
    oSituatedEClass = createEClass(OSITUATED);
    createEAttribute(oSituatedEClass, OSITUATED__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getJcmModel_Institution(), this.getInstitution(), null, "institution", null, 0, -1, JcmModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getJcmModel_DOrgPath(), this.getDOrgPath(), null, "dOrgPath", null, 0, -1, JcmModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getJcmModel_DJavaPath(), this.getDJavaPath(), null, "dJavaPath", null, 0, -1, JcmModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(dOrgPathEClass, DOrgPath.class, "DOrgPath", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDOrgPath_OrgPath(), this.getFileName(), null, "orgPath", null, 0, -1, DOrgPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(dJavaPathEClass, DJavaPath.class, "DJavaPath", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDJavaPath_AslPath(), this.getFileName(), null, "aslPath", null, 0, -1, DJavaPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAgent_FocusNS(), ecorePackage.getEString(), "focusNS", null, 0, -1, Agent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getArtifact_AgentNS(), ecorePackage.getEString(), "agentNS", null, 0, -1, Artifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getInstitution_FileName(), this.getOFileName(), null, "fileName", null, 0, 1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInstitution_WsNames(), ecorePackage.getEString(), "wsNames", null, 0, -1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInstitution_Other(), ecorePackage.getEString(), "other", null, 0, -1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInstitution_String(), ecorePackage.getEString(), "string", null, 0, -1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInstitution_Val(), ecorePackage.getEInt(), "val", null, 0, -1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getInstitution_Literal(), this.getLiteral(), null, "literal", null, 0, -1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getInstitution_Val_real(), ecorePackage.getEDouble(), "val_real", null, 0, -1, Institution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getOrganisation_Situated(), this.getOSituated(), null, "situated", null, 0, -1, Organisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(oSituatedEClass, OSituated.class, "OSituated", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOSituated_Name(), ecorePackage.getEString(), "name", null, 0, 1, OSituated.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

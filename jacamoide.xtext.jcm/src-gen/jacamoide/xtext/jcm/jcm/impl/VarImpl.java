 ...
 * <ul>
 *   <li>{@link jacamoide.xtext.jcm.jcm.impl.VarImpl#getVar <em>Var</em>}</li>
 *   <li>{@link jacamoide.xtext.jcm.jcm.impl.VarImpl#getUnnamedvar <em>Unnamedvar</em>}</li>
 *   <li>{@link jacamoide.xtext.jcm.jcm.impl.VarImpl#getList <em>List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VarImpl extends MinimalEObjectImpl.Container implements Var
{
  ...
  {
    return JcmPackage.Literals.VAR;
  }
  ...
  public void setVar(String newVar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JcmPackage.VAR__VAR, oldVar, var));
  }
  ...
  public void setUnnamedvar(String newUnnamedvar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JcmPackage.VAR__UNNAMEDVAR, oldUnnamedvar, unnamedvar));
  }
  ...
  public NotificationChain basicSetList(List newList, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JcmPackage.VAR__LIST, oldList, newList);
  ...
  public void setList(List newList)
  {
    if (newList != list)
    {
      ...
      if (list != null)
        msgs = ((InternalEObject)list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JcmPackage.VAR__LIST, null, msgs);
      if (newList != null)
        msgs = ((InternalEObject)newList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JcmPackage.VAR__LIST, null, msgs);
      msgs = basicSetList(newList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JcmPackage.VAR__LIST, newList, newList));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JcmPackage.VAR__VAR:
        return getVar();
      case JcmPackage.VAR__UNNAMEDVAR:

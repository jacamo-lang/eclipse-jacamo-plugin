...
public interface JcmPackage extends EPackage
{
   ...
   * @ordered
   */
  int JCM_MODEL__DASL_PATH = 7;

  /**
   * The feature id for the '<em><b>DOrg Path</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int JCM_MODEL__DORG_PATH = 8;

  /**
   * The feature id for the '<em><b>DJava Path</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int JCM_MODEL__DJAVA_PATH = 9;
   ...
   * @ordered
   */
  int JCM_MODEL_FEATURE_COUNT = 12;
  ...
  /**
   * The meta object id for the '{@link jacamoide.xtext.jcm.jcm.impl.DOrgPathImpl <em>DOrg Path</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see jacamoide.xtext.jcm.jcm.impl.DOrgPathImpl
   * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getDOrgPath()
   * @generated
   */
  int DORG_PATH = 4;

  /**
   * The feature id for the '<em><b>Org Path</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DORG_PATH__ORG_PATH = 0;

  /**
   * The number of structural features of the '<em>DOrg Path</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DORG_PATH_FEATURE_COUNT = 1;

  /**
   * The meta object id for the '{@link jacamoide.xtext.jcm.jcm.impl.DJavaPathImpl <em>DJava Path</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see jacamoide.xtext.jcm.jcm.impl.DJavaPathImpl
   * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getDJavaPath()
   * @generated
   */
  int DJAVA_PATH = 5;
   ...
   * @ordered
   */
  int DJAVA_PATH__ASL_PATH = 0;

  /**
   * The number of structural features of the '<em>DJava Path</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DJAVA_PATH_FEATURE_COUNT = 1;
  ...
  /**
   * The feature id for the '<em><b>Focus NS</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int AGENT__FOCUS_NS = 11;
  ...
  /**
   * The feature id for the '<em><b>Agent NS</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ARTIFACT__AGENT_NS = 2;
  ...
  /**
   * The meta object id for the '{@link jacamoide.xtext.jcm.jcm.impl.InstitutionImpl <em>Institution</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see jacamoide.xtext.jcm.jcm.impl.InstitutionImpl
   * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getInstitution()
   * @generated
   */
  int INSTITUTION = 11;
   ...
   * @ordered
   */
  int INSTITUTION__FILE_NAME = 1;

  /**
   * The feature id for the '<em><b>Ws Names</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int INSTITUTION__WS_NAMES = 2;
   ...
   * @ordered
   */
  int INSTITUTION_FEATURE_COUNT = 8;
  ...
  /**
   * The feature id for the '<em><b>Situated</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ORGANISATION__SITUATED = 6;
   ...
   * @ordered
   */
  int ORGANISATION_FEATURE_COUNT = 8;
  ...
  /**
   * The meta object id for the '{@link jacamoide.xtext.jcm.jcm.impl.OSituatedImpl <em>OSituated</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see jacamoide.xtext.jcm.jcm.impl.OSituatedImpl
   * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getOSituated()
   * @generated
   */
  int OSITUATED = 15;
   ...
   * @ordered
   */
  int OSITUATED__NAME = 0;

  /**
   * The number of structural features of the '<em>OSituated</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int OSITUATED_FEATURE_COUNT = 1;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.JcmModel#getInstitution <em>Institution</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Institution</em>'.
   * @see jacamoide.xtext.jcm.jcm.JcmModel#getInstitution()
   * @see #getJcmModel()
   * @generated
   */
  EReference getJcmModel_Institution();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.JcmModel#getDOrgPath <em>DOrg Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>DOrg Path</em>'.
   * @see jacamoide.xtext.jcm.jcm.JcmModel#getDOrgPath()
   * @see #getJcmModel()
   * @generated
   */
  EReference getJcmModel_DOrgPath();

  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.JcmModel#getDJavaPath <em>DJava Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>DJava Path</em>'.
   * @see jacamoide.xtext.jcm.jcm.JcmModel#getDJavaPath()
   * @see #getJcmModel()
   * @generated
   */
  EReference getJcmModel_DJavaPath();
  ...
  /**
   * Returns the meta object for class '{@link jacamoide.xtext.jcm.jcm.DOrgPath <em>DOrg Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>DOrg Path</em>'.
   * @see jacamoide.xtext.jcm.jcm.DOrgPath
   * @generated
   */
  EClass getDOrgPath();

  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.DOrgPath#getOrgPath <em>Org Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Org Path</em>'.
   * @see jacamoide.xtext.jcm.jcm.DOrgPath#getOrgPath()
   * @see #getDOrgPath()
   * @generated
   */
  EReference getDOrgPath_OrgPath();

  /**
   * Returns the meta object for class '{@link jacamoide.xtext.jcm.jcm.DJavaPath <em>DJava Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>DJava Path</em>'.
   * @see jacamoide.xtext.jcm.jcm.DJavaPath
   * @generated
   */
  EClass getDJavaPath();

  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.DJavaPath#getAslPath <em>Asl Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Asl Path</em>'.
   * @see jacamoide.xtext.jcm.jcm.DJavaPath#getAslPath()
   * @see #getDJavaPath()
   * @generated
   */
  EReference getDJavaPath_AslPath();
  ...
  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Agent#getFocusNS <em>Focus NS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Focus NS</em>'.
   * @see jacamoide.xtext.jcm.jcm.Agent#getFocusNS()
   * @see #getAgent()
   * @generated
   */
  EAttribute getAgent_FocusNS();
  ...
  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Artifact#getAgentNS <em>Agent NS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Agent NS</em>'.
   * @see jacamoide.xtext.jcm.jcm.Artifact#getAgentNS()
   * @see #getArtifact()
   * @generated
   */
  EAttribute getArtifact_AgentNS();
  ...
  /**
   * Returns the meta object for class '{@link jacamoide.xtext.jcm.jcm.Institution <em>Institution</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Institution</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution
   * @generated
   */
  EClass getInstitution();

  /**
   * Returns the meta object for the attribute '{@link jacamoide.xtext.jcm.jcm.Institution#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getName()
   * @see #getInstitution()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link jacamoide.xtext.jcm.jcm.Institution#getFileName <em>File Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>File Name</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getFileName()
   * @see #getInstitution()
   * @generated
   */
  EReference getInstitution_FileName();

  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Institution#getWsNames <em>Ws Names</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Ws Names</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getWsNames()
   * @see #getInstitution()
   * @generated
   */
  EAttribute getInstitution_WsNames();

  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Institution#getOther <em>Other</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Other</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getOther()
   * @see #getInstitution()
   * @generated
   */
  EAttribute getInstitution_Other();

  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Institution#getString <em>String</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>String</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getString()
   * @see #getInstitution()
   * @generated
   */
  EAttribute getInstitution_String();

  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Institution#getVal <em>Val</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Val</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getVal()
   * @see #getInstitution()
   * @generated
   */
  EAttribute getInstitution_Val();

  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.Institution#getLiteral <em>Literal</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Literal</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getLiteral()
   * @see #getInstitution()
   * @generated
   */
  EReference getInstitution_Literal();

  /**
   * Returns the meta object for the attribute list '{@link jacamoide.xtext.jcm.jcm.Institution#getVal_real <em>Val real</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Val real</em>'.
   * @see jacamoide.xtext.jcm.jcm.Institution#getVal_real()
   * @see #getInstitution()
   * @generated
   */
  EAttribute getInstitution_Val_real();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link jacamoide.xtext.jcm.jcm.Organisation#getSituated <em>Situated</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Situated</em>'.
   * @see jacamoide.xtext.jcm.jcm.Organisation#getSituated()
   * @see #getOrganisation()
   * @generated
   */
  EReference getOrganisation_Situated();
  ...
  /**
   * Returns the meta object for class '{@link jacamoide.xtext.jcm.jcm.OSituated <em>OSituated</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>OSituated</em>'.
   * @see jacamoide.xtext.jcm.jcm.OSituated
   * @generated
   */
  EClass getOSituated();

  /**
   * Returns the meta object for the attribute '{@link jacamoide.xtext.jcm.jcm.OSituated#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see jacamoide.xtext.jcm.jcm.OSituated#getName()
   * @see #getOSituated()
   * @generated
   */
  EAttribute getOSituated_Name();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Institution</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference JCM_MODEL__INSTITUTION = eINSTANCE.getJcmModel_Institution();
    ...
    /**
     * The meta object literal for the '<em><b>DOrg Path</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference JCM_MODEL__DORG_PATH = eINSTANCE.getJcmModel_DOrgPath();

    /**
     * The meta object literal for the '<em><b>DJava Path</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference JCM_MODEL__DJAVA_PATH = eINSTANCE.getJcmModel_DJavaPath();
    ...
    /**
     * The meta object literal for the '{@link jacamoide.xtext.jcm.jcm.impl.DOrgPathImpl <em>DOrg Path</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see jacamoide.xtext.jcm.jcm.impl.DOrgPathImpl
     * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getDOrgPath()
     * @generated
     */
    EClass DORG_PATH = eINSTANCE.getDOrgPath();

    /**
     * The meta object literal for the '<em><b>Org Path</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference DORG_PATH__ORG_PATH = eINSTANCE.getDOrgPath_OrgPath();

    /**
     * The meta object literal for the '{@link jacamoide.xtext.jcm.jcm.impl.DJavaPathImpl <em>DJava Path</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see jacamoide.xtext.jcm.jcm.impl.DJavaPathImpl
     * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getDJavaPath()
     * @generated
     */
    EClass DJAVA_PATH = eINSTANCE.getDJavaPath();
     ...
     * @generated
     */
    EReference DJAVA_PATH__ASL_PATH = eINSTANCE.getDJavaPath_AslPath();
    ...
    /**
     * The meta object literal for the '<em><b>Focus NS</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute AGENT__FOCUS_NS = eINSTANCE.getAgent_FocusNS();
    ...
    /**
     * The meta object literal for the '<em><b>Agent NS</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute ARTIFACT__AGENT_NS = eINSTANCE.getArtifact_AgentNS();
    ...
    /**
     * The meta object literal for the '{@link jacamoide.xtext.jcm.jcm.impl.InstitutionImpl <em>Institution</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see jacamoide.xtext.jcm.jcm.impl.InstitutionImpl
     * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getInstitution()
     ...
     * @generated
     */
    EReference INSTITUTION__FILE_NAME = eINSTANCE.getInstitution_FileName();

    /**
     * The meta object literal for the '<em><b>Ws Names</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute INSTITUTION__WS_NAMES = eINSTANCE.getInstitution_WsNames();
     ...
     * @generated
     */
    EAttribute INSTITUTION__OTHER = eINSTANCE.getInstitution_Other();
     ...
     * @generated
     */
    EAttribute INSTITUTION__STRING = eINSTANCE.getInstitution_String();
     ...
     * @generated
     */
    EAttribute INSTITUTION__VAL = eINSTANCE.getInstitution_Val();
     ...
     * @generated
     */
    EReference INSTITUTION__LITERAL = eINSTANCE.getInstitution_Literal();
     ...
     * @generated
     */
    EAttribute INSTITUTION__VAL_REAL = eINSTANCE.getInstitution_Val_real();
    ...
    /**
     * The meta object literal for the '<em><b>Situated</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference ORGANISATION__SITUATED = eINSTANCE.getOrganisation_Situated();
    ...
    /**
     * The meta object literal for the '{@link jacamoide.xtext.jcm.jcm.impl.OSituatedImpl <em>OSituated</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see jacamoide.xtext.jcm.jcm.impl.OSituatedImpl
     * @see jacamoide.xtext.jcm.jcm.impl.JcmPackageImpl#getOSituated()
     * @generated
     */
    EClass OSITUATED = eINSTANCE.getOSituated();
     ...
     * @generated
     */
    EAttribute OSITUATED__NAME = eINSTANCE.getOSituated_Name();

 ...
 *   <li>{@link jacamoide.xtext.jcm.jcm.Organisation#getSituated <em>Situated</em>}</li>
...
public interface Organisation extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Situated</b></em>' containment reference list.
   * The list contents are of type {@link jacamoide.xtext.jcm.jcm.OSituated}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Situated</em>' containment reference list.
   * @see jacamoide.xtext.jcm.jcm.JcmPackage#getOrganisation_Situated()
   * @model containment="true"
   * @generated
   */
  EList<OSituated> getSituated();

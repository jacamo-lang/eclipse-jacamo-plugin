 ...
 *   <li>{@link jacamoide.xtext.jcm.jcm.JcmModel#getInstitution <em>Institution</em>}</li>
 ...
 *   <li>{@link jacamoide.xtext.jcm.jcm.JcmModel#getDOrgPath <em>DOrg Path</em>}</li>
 *   <li>{@link jacamoide.xtext.jcm.jcm.JcmModel#getDJavaPath <em>DJava Path</em>}</li>
...
public interface JcmModel extends EObject
{
   ...
   * The list contents are of type {@link jacamoide.xtext.jcm.jcm.Institution}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Institution</em>' containment reference list.
   * @see jacamoide.xtext.jcm.jcm.JcmPackage#getJcmModel_Institution()
   * @model containment="true"
   * @generated
   */
  EList<Institution> getInstitution();
  ...
  /**
   * Returns the value of the '<em><b>DOrg Path</b></em>' containment reference list.
   * The list contents are of type {@link jacamoide.xtext.jcm.jcm.DOrgPath}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>DOrg Path</em>' containment reference list.
   * @see jacamoide.xtext.jcm.jcm.JcmPackage#getJcmModel_DOrgPath()
   * @model containment="true"
   * @generated
   */
  EList<DOrgPath> getDOrgPath();

  /**
   * Returns the value of the '<em><b>DJava Path</b></em>' containment reference list.
   * The list contents are of type {@link jacamoide.xtext.jcm.jcm.DJavaPath}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>DJava Path</em>' containment reference list.
   * @see jacamoide.xtext.jcm.jcm.JcmPackage#getJcmModel_DJavaPath()
   * @model containment="true"
   * @generated
   */
  EList<DJavaPath> getDJavaPath();

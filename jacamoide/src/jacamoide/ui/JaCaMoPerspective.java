...
public class JaCaMoPerspective implements IPerspectiveFactory {
	
	/**
	 * Constructs a new Default layout engine.
	 */
	public JaCaMoPerspective() {
		super();
	}
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		folder.addView("jacamoide.navigatorView");
		...
		layout.addShowViewShortcut("jacamoide.navigatorView");
		...
		layout.addNewWizardShortcut("jacamoide.newJaCaMoProjectWizard");
		layout.addNewWizardShortcut("jacamoide.newAgentTypeWizard");
		//layout.addNewWizardShortcut("jacamoide.newAgentWizard");
		layout.addNewWizardShortcut("jacamoide.newArtifactWizard");
		layout.addNewWizardShortcut("jacamoide.newInternalActionWizard");
		layout.addNewWizardShortcut("jacamoide.newAslFileWizard");
		layout.addNewWizardShortcut("jacamoide.newOrganizationWizard");
		layout.addNewWizardShortcut("jacamoide.newProtocolWizard");
